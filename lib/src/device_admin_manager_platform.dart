...
import 'device_admin_manager_platform_impl.dart';

abstract class DeviceAdminManagerPlatform extends PlatformInterface {
  /// Constructs a DevicePolicyControllerPlatform.
  DeviceAdminManagerPlatform() : super(token: _token);

  static final Object _token = Object();

  static DeviceAdminManagerPlatform _instance = DeviceAdminManagerPlatformImpl();

  /// The default instance of [DeviceAdminManagerPlatform] to use.
  ///
  /// Defaults to [DeviceAdminManagerPlatformImpl].
  static DeviceAdminManagerPlatform get instance => _instance;

  /// Platform-specific implementations should set this with their own
  /// platform-specific class that extends [DeviceAdminManagerPlatform] when
  /// they register themselves.
  static set instance(DeviceAdminManagerPlatform instance) {
  ...
  void handleBootCompleted(FutureOr<dynamic> Function(DeviceAdminManager dpc) handler);
  ...
  Future<bool> enableFactoryResetProtection();
